...
//
  //      }
        Map<Integer, List<DateItem>> DatesGrouped =
                dateItems.stream().collect(Collectors.groupingBy(w -> w.getYear()));
        System.out.println(DatesGrouped.keySet() + " " DatesGrouped.entrySet.);
    }
}
